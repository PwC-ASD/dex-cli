...
It has these top-level messages:
	...
	CreateClientReq
	CreateClientResp
	AddClientRedirectUriReq
	AddClientRedirectUriResp
	RemoveClientRedirectUriReq
	RemoveClientRedirectUriResp
	DeleteClientReq
	DeleteClientResp
	Password
	CreatePasswordReq
...
// AddClientRedirectUriReq is a request to register a new redirect URI to an existing client.
type AddClientRedirectUriReq struct {
	// The ID of the client.
	Id          string `protobuf:"bytes,1,opt,name=id" json:"id,omitempty"`
	RedirectUri string `protobuf:"bytes,2,opt,name=redirect_uri,json=redirectUri" json:"redirect_uri,omitempty"`
}

func (m *AddClientRedirectUriReq) Reset()                    { *m = AddClientRedirectUriReq{} }
func (m *AddClientRedirectUriReq) String() string            { return proto.CompactTextString(m) }
func (*AddClientRedirectUriReq) ProtoMessage()               {}
func (*AddClientRedirectUriReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }

func (m *AddClientRedirectUriReq) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *AddClientRedirectUriReq) GetRedirectUri() string {
	if m != nil {
...
// AddClientRedirectUriResp return the response from registering a new redirect URI to an existing client.
type AddClientRedirectUriResp struct {
	ClientNotFound           bool `protobuf:"varint,1,opt,name=client_not_found,json=clientNotFound" json:"client_not_found,omitempty"`
	RedirectUriAlreadyExists bool `protobuf:"varint,2,opt,name=redirect_uri_already_exists,json=redirectUriAlreadyExists" json:"redirect_uri_already_exists,omitempty"`
}

func (m *AddClientRedirectUriResp) Reset()                    { *m = AddClientRedirectUriResp{} }
func (m *AddClientRedirectUriResp) String() string            { return proto.CompactTextString(m) }
func (*AddClientRedirectUriResp) ProtoMessage()               {}
func (*AddClientRedirectUriResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }

func (m *AddClientRedirectUriResp) GetClientNotFound() bool {
	if m != nil {
		return m.ClientNotFound
	}
	return false
}

func (m *AddClientRedirectUriResp) GetRedirectUriAlreadyExists() bool {
	if m != nil {
		return m.RedirectUriAlreadyExists
	}
	return false
}

// RemoveClientRedirectUriReq is a request to remove a redirect URI of an existing client.
type RemoveClientRedirectUriReq struct {
	// The ID of the client.
	Id          string `protobuf:"bytes,1,opt,name=id" json:"id,omitempty"`
	RedirectUri string `protobuf:"bytes,2,opt,name=redirect_uri,json=redirectUri" json:"redirect_uri,omitempty"`
}

func (m *RemoveClientRedirectUriReq) Reset()                    { *m = RemoveClientRedirectUriReq{} }
func (m *RemoveClientRedirectUriReq) String() string            { return proto.CompactTextString(m) }
func (*RemoveClientRedirectUriReq) ProtoMessage()               {}
func (*RemoveClientRedirectUriReq) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }

func (m *RemoveClientRedirectUriReq) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *RemoveClientRedirectUriReq) GetRedirectUri() string {
	if m != nil {
		return m.RedirectUri
	}
	return ""
...
// RemoveClientRedirectUriResp return the response from removing a redirect URI of an existing client.
type RemoveClientRedirectUriResp struct {
	ClientNotFound      bool `protobuf:"varint,1,opt,name=client_not_found,json=clientNotFound" json:"client_not_found,omitempty"`
	RedirectUriNotFound bool `protobuf:"varint,2,opt,name=redirect_uri_not_found,json=redirectUriNotFound" json:"redirect_uri_not_found,omitempty"`
}

func (m *RemoveClientRedirectUriResp) Reset()                    { *m = RemoveClientRedirectUriResp{} }
func (m *RemoveClientRedirectUriResp) String() string            { return proto.CompactTextString(m) }
func (*RemoveClientRedirectUriResp) ProtoMessage()               {}
func (*RemoveClientRedirectUriResp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }

func (m *RemoveClientRedirectUriResp) GetClientNotFound() bool {
	if m != nil {
		return m.ClientNotFound
	}
	return false
...
func (m *RemoveClientRedirectUriResp) GetRedirectUriNotFound() bool {
	if m != nil {
		return m.RedirectUriNotFound
	}
	return false
}
...
func init() {
	...
	proto.RegisterType((*AddClientRedirectUriReq)(nil), "api.AddClientRedirectUriReq")
	proto.RegisterType((*AddClientRedirectUriResp)(nil), "api.AddClientRedirectUriResp")
	proto.RegisterType((*RemoveClientRedirectUriReq)(nil), "api.RemoveClientRedirectUriReq")
	proto.RegisterType((*RemoveClientRedirectUriResp)(nil), "api.RemoveClientRedirectUriResp")
...
type DexClient interface {
	...
	// AddClientRedirectUri register a redirect URI to an existing client.
	AddClientRedirectUri(ctx context.Context, in *AddClientRedirectUriReq, opts ...grpc.CallOption) (*AddClientRedirectUriResp, error)
	// RemoveClientRedirectUri remove a redirect URI of an existing client.
	RemoveClientRedirectUri(ctx context.Context, in *RemoveClientRedirectUriReq, opts ...grpc.CallOption) (*RemoveClientRedirectUriResp, error)
...
func (c *dexClient) AddClientRedirectUri(ctx context.Context, in *AddClientRedirectUriReq, opts ...grpc.CallOption) (*AddClientRedirectUriResp, error) {
	out := new(AddClientRedirectUriResp)
	err := grpc.Invoke(ctx, "/api.Dex/AddClientRedirectUri", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dexClient) RemoveClientRedirectUri(ctx context.Context, in *RemoveClientRedirectUriReq, opts ...grpc.CallOption) (*RemoveClientRedirectUriResp, error) {
	out := new(RemoveClientRedirectUriResp)
	err := grpc.Invoke(ctx, "/api.Dex/RemoveClientRedirectUri", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DexServer interface {
	...
	// AddClientRedirectUri register a redirect URI to an existing client.
	AddClientRedirectUri(context.Context, *AddClientRedirectUriReq) (*AddClientRedirectUriResp, error)
	// RemoveClientRedirectUri remove a redirect URI of an existing client.
	RemoveClientRedirectUri(context.Context, *RemoveClientRedirectUriReq) (*RemoveClientRedirectUriResp, error)
	// DeleteClient deletes the provided client.
...
func _Dex_AddClientRedirectUri_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddClientRedirectUriReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DexServer).AddClientRedirectUri(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Dex/AddClientRedirectUri",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DexServer).AddClientRedirectUri(ctx, req.(*AddClientRedirectUriReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Dex_RemoveClientRedirectUri_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveClientRedirectUriReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DexServer).RemoveClientRedirectUri(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Dex/RemoveClientRedirectUri",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DexServer).RemoveClientRedirectUri(ctx, req.(*RemoveClientRedirectUriReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Dex_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddClientRedirectUri",
			Handler:    _Dex_AddClientRedirectUri_Handler,
		},
		{
			MethodName: "RemoveClientRedirectUri",
			Handler:    _Dex_RemoveClientRedirectUri_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
